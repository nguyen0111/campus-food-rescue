...
export const canteens: Canteen[] = [
  ...
  {
    id: "skinnarila",
    name: "Ravintola Skinnarila",
    type: "student",
    description: "LUT campus main restaurant in Lappeenranta",
    city: "Lappeenranta",
    address: "Yliopistonkatu 34, Lappeenranta",
    website: "https://skinnarila.fi",
...
export const meals: Meal[] = [
  ...
  // Skinnarila - Lappeenranta (similar to Isku business menu)
  {
    id: "skinnarila-1",
    canteenId: "skinnarila",
    title: "Chicken Stew Burgundy",
    studentPrice: 3.40,
    regularPrice: 13.80,
    portionsLeft: 8,
    ingredients: ["Chicken", "Burgundy Wine", "Mushrooms", "Cream"],
    tags: ["French", "Premium"],
    pickupTime: "13:00",
    image: "🍗",
    co2Saved: 2.0,
  ...
  },
  {
    id: "skinnarila-2",
    canteenId: "skinnarila",
    title: "Creamy Potato Salmon Casserole",
    studentPrice: 3.70,
    regularPrice: 14.60,
    portionsLeft: 6,
    ingredients: ["Salmon", "Potatoes", "Dill", "Cream"],
    tags: ["Nordic", "Fish", "Comfort"],
    pickupTime: "13:00",
    image: "🐟",
    co2Saved: 2.1,
    urgencyLevel: "medium",
  ...
  },
  {
    id: "skinnarila-3",
    canteenId: "skinnarila",
    title: "Roasted Chicken with Seasonal Vegetables",
    studentPrice: 3.50,
    regularPrice: 14.20,
    portionsLeft: 10,
    ingredients: ["Chicken", "Seasonal Vegetables", "Gravy"],
